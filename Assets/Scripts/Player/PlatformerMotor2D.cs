...
public class PlatformerMotor2D : MonoBehaviour
{
    ...
    /// <summary>
    /// Delegate to attach to when the motor's normalizedXMovement has been changed. The float passed is the normalizedXMovement.
    /// </summary>
    ...
    /// <summary>
    /// Delegate to attach to when the motor ground jumps.
    /// </summary>
    ...
    private float _normalizedXMovement;
    ...
    public float normalizedXMovement
    {
        get
        {
            return _normalizedXMovement;
        }
        set
        {
            if (_normalizedXMovement != value && onMove != null)
                onMove(value);

            _normalizedXMovement = value;
        }
    }
